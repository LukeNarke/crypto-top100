    ...
    <>
      ...
      <section>
        <p className="title-heading">
          {" "}
          Know all about Top 100 Crypto Currencies in world according to their
              ...
              <tr className="row">
                ...
                <th className="coin-marketcap-head">
                  ...
                  <span className="marketcap-tooltip">
                    {" "}
                    &#9432;
                    <span className="marketcap-tooltiptext">
                ...
                <th className="coin-volume-head">
                  ...
                  <span className="volume-tooltip">
                    {" "}
                    &#9432;
                    <span className="volume-tooltiptext">
                ...
                <th className="coin-circulation-head">
                  ...
                  <span className="circulation-tooltip">
                    {" "}
                    &#9432;
                    <span className="circulation-tooltiptext">
        ...
        <a
          href="https://github.com/lukenarke"
          target="_blank"
          rel="noreferrer"
          className="view-code"
        >
